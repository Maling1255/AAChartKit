...
@class AAScrollablePlotArea, AAOptions, AALabels;
...
AAPropStatementAndPropSetFuncStatement(strong, AAChartModel, NSNumber *, xAxisTickLength) // maling x 轴刻度线长度
...
AAPropStatementAndPropSetFuncStatement(strong, AAChartModel, AAOptions *, options)  // maling配置项
AAPropStatementAndPropSetFuncStatement(strong, AAChartModel, AALabels  *, labels)   // maling 标签
