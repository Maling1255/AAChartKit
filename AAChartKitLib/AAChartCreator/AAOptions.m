...
AAPropSetFuncImplementation(AAOptions, AALabels      *, labels)  // maling 标签
...
+ (AAOptions *)configureChartOptionsWithAAChartModel:(AAChartModel *)aaChartModel {
    ...
    if (aaChartModel.options) {
        return aaChartModel.options;
    }
    ...
    aaChartModel.options = aaOptions;
...
+ (void)configureAxisContentAndStyleWithAAOptions:(AAOptions *)aaOptions
    ...
    if (   aaChartType == AAChartTypeColumn
        ...
        .tickLengthSet(aaChartModel.xAxisTickLength)  // x轴刻度长度
