...
AAPropSetFuncImplementation(AAStyle, NSNumber *, left) // maling 位置配置
AAPropSetFuncImplementation(AAStyle, NSNumber *, top) // maling 位置配置
AAPropSetFuncImplementation(AAStyle, NSNumber *, right) // maling 位置配置
AAPropSetFuncImplementation(AAStyle, NSNumber *, bottom) // maling 位置配置
