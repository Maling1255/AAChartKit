...
AAPropStatementAndPropSetFuncStatement(copy, AAStyle, NSNumber *, left) // maling  位置
AAPropStatementAndPropSetFuncStatement(copy, AAStyle, NSNumber *, top)
AAPropStatementAndPropSetFuncStatement(copy, AAStyle, NSNumber *, right)
AAPropStatementAndPropSetFuncStatement(copy, AAStyle, NSNumber *, bottom)
