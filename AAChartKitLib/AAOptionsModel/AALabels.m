...
AAPropSetFuncImplementation(AALabels, NSArray <AALabelsItems *>*, items)//标签项数组
...
@implementation AALabelsItems

AAPropSetFuncImplementation(AALabelsItems, NSString *, html)  // HTML显示内容
AAPropSetFuncImplementation(AALabelsItems, AAStyle  *, style)  // CSS样式
