...
@class AAStyle, AAJSStringPurer, AALabelsItems;
...
AAPropStatementAndPropSetFuncStatement(strong, AALabels, NSArray <AALabelsItems *>*, items)//标签项数组
...
@interface AALabelsItems : NSObject

AAPropStatementAndPropSetFuncStatement(copy, AALabelsItems, NSString *, html)
AAPropStatementAndPropSetFuncStatement(copy, AALabelsItems, AAStyle *, style)
