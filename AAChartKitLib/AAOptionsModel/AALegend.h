...
AAPropStatementAndPropSetFuncStatement(assign, AALegend, BOOL,          reversed) // maling 设定图例项排列顺序是否相对于数列的排列顺序做逆序
AAPropStatementAndPropSetFuncStatement(assign, AALegend, BOOL,          rtl) // maling 设定图例符号是否在文本右边。 用于阿拉伯语和希伯来语。 默认是：false.
